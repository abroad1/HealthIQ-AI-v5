...
- **v1.3:** adds the governed lifestyle / questionnaire / medication context workstream; inserts BE-S0 before narrative enablement; clarifies context-governance rules; records KB-S39 as completed baseline work on `main`; confirms KB-S54 HIGH classification, BE-S1 classification correction, and KB-S58 scope-boundary rule.
