...
|---|---|
| What the product really is today — honest ledger | `docs/strategy/PRODUCT_REVIEW_AND_STRATEGIC_RESET_2026-04.md` |
| What the three engine bugs were and where they live in code | `docs/intelligence/PRODUCT_REALITY_AND_DIRECTION_AUDIT.md` |
| What analytical signals are covered and what is missing | `docs/intelligence/METABOLIC_PATHWAY_COVERAGE_AUDIT_2026-03-20.md` |
...
|---|---|---|
| `docs/strategy/HealthIQ_AI_Strategic-Vision-and-12-Month-Sprint-Plan_v1.5_FINAL_ADOPTED.md` | **AUTHORITATIVE** | Master strategic record for Phase 1. Read alongside the April 2026 reset. |
...
| `docs/strategy/PRODUCT_REVIEW_AND_STRATEGIC_RESET_2026-04.md` | **AUTHORITATIVE — current truth** | April 2026 full product review. Most honest state-of-truth document. |
| `docs/strategy/RESET_SPRINT_PLAN_2026-04.md` | **AUTHORITATIVE — completed plan** | The 8-sprint reset plan. All sprints now complete. See `docs/SPRINT_STATUS.md`. |
...
| `docs/strategy/HealthIQ_Phase1_Launch_Posture.md` | **SUPPORTING** | Phase 1 launch posture. Currency uncertain — verify against April review. |
...
| Document | Status | Notes |
|---|---|---|
| `docs/intelligence/PRODUCT_REALITY_AND_DIRECTION_AUDIT.md` | **AUTHORITATIVE — current truth** | April 2026. Code-grounded. Named the engine bugs with file/line citations. |
| `docs/intelligence/METABOLIC_PATHWAY_COVERAGE_AUDIT_2026-03-20.md` | **AUTHORITATIVE** | Analytical coverage map. WHY Wave 1 done; Wave 2 not yet started. |
| `docs/intelligence/DOMAIN_NARRATIVE_CONTRACT_WAVE1.md` | **AUTHORITATIVE** | Active contract for Wave 1 domain narrative structure. |
| `docs/intelligence/PRIMARY_CONCERN_AND_RANKED_AMBIGUITY_POLICY_v1.md` | **AUTHORITATIVE** | Policy for primary concern and ranked ambiguity. |
| `docs/intelligence/Wave1-codebase-analysis_v3.md` | **SUPPORTING** | Wave 1 implementation analysis. v3 is latest. |
| `docs/intelligence/2026-04-12_*.md` (4 files) | **SUPPORTING** | April 2026 investigation notes. Operational reference. |
...
| `docs/archive/sprint-history/investigations/` | **ARCHIVE** | ~30 sprint preflight investigations. Historical record only. |
...
| Document | Status | Notes |
|---|---|---|
| `docs/frontend/HealthIQ_Final_Results_Journey_Recommendation_Paper_v6.md` | **AUTHORITATIVE** | Results page experience authority. v6 is current. |
| `docs/frontend/Interpretation_Display_Layer_Design_Lock.md` | **AUTHORITATIVE** | IDL design lock. |
| `docs/frontend/HealthIQ_IDL_Naming_Decision_Note_Approved.md` | **AUTHORITATIVE** | IDL naming decision. Approved and locked. |
| `docs/frontend/QUESTIONNAIRE_UX_REDESIGN_BACKGROUND.md` | **AUTHORITATIVE** | Q-1 questionnaire redesign background. |
| `docs/frontend/QUESTIONNAIRE_VISUAL_REDESIGN_Q2_BACKGROUND.md` | **AUTHORITATIVE** | Q-2 premium visual layer background. |
| `docs/frontend/CLAUDE_TRANSLATION_SPEC_v1.md` | **SUPPORTING** | Translation spec for Layer C narrative. |
...
| `docs/archive/sprint-history/context/UX_UI_GUIDE.md` | **ARCHIVE** | Pre-governance era. Moved to archive. |
...
| `docs/governance/AUTOMATION_BUS_SOP_v1.3.1.md` | **AUTHORITATIVE — ACTIVE SOP** | Operative governance SOP. |
| `docs/governance/KNOWLEDGE_BUS_SOP_v1.3.md` | **AUTHORITATIVE — ACTIVE SOP** | Operative Knowledge Bus SOP. |
| `docs/governance/CURSOR_OPERATING_POLICY.md` | **AUTHORITATIVE** | Cursor operating policy within the bus. |
...
- **For governance/SOPs:** `docs/governance/AUTOMATION_BUS_SOP_v1.3.1.md` and `docs/governance/KNOWLEDGE_BUS_SOP_v1.3.md`
...
| `docs/archive/superseded/AUTOMATION_BUS_SOP_v1.2.md` / `v1.3.md` | SUPERSEDED — use v1.3.1 in `docs/governance/`. |
| `docs/archive/superseded/KNOWLEDGE_BUS_SOP_v1.2.md` | SUPERSEDED — use v1.3 in `docs/governance/`. |
