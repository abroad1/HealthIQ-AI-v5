...
version: "0.3"
status: READY_FOR_PRODUCT_RATIFICATION_AND_REGULATORY_REVIEW
...
# HealthIQ Clinical Finding Prioritisation Contract v0.3
...
The initial tier is the more serious of the two — that is, the numerically lower tier.
...
This applies where incomplete data prevents meaningful assessment of one or more clinically important questions.
...
`READY_FOR_PRODUCT_RATIFICATION_AND_REGULATORY_REVIEW`

Confirmatory independent medical review has established that:

- all v0.1 defects were resolved in v0.2;
- the remaining v0.2 issues were sentence-level;
- no further independent medical review is required after the four v0.3 corrections;
- Head of Medical Research confirmation is sufficient to close the clinical-policy drafting stage.

Next actions:

1. Anthony product ratification.
2. Open specialist regulatory review in parallel.
3. After ratification and subject to regulatory constraints, author the hepatic pilot specification.
