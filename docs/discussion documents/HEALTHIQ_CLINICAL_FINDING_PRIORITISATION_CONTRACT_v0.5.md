...
version: "0.5"
status: CLINICALLY_VALIDATED_FOR_DOMAIN_AUTHORING
...
# HealthIQ Clinical Finding Prioritisation Contract v0.5
...
`CLINICALLY_VALIDATED_FOR_DOMAIN_AUTHORING`
...
Head of Medical Research confirmation:
...
1. Author the Haematology Clinical Prioritisation Pilot Specification against v0.5.
2. Continue specialist regulatory review in parallel.
3. Retain the hepatic ruleset as parked domain evidence pending haematology dependencies.
