...
# HealthIQ Clinical Finding Prioritisation Contract v0.6.1
...
v0.6.1 additionally records, on product authority:
...
1. Final independent cross-domain consistency review of v0.6.1 and consolidated ruleset v0.3.
2. Incorporate the supplemental electrolyte evidence and the fixed HMR adjudications into the renal/electrolyte and haematology domain rulesets.
