...
| AB | `lifestyle_context` | SSOT lifestyle fixture (alcohol_units_per_week=10, moderate+); no questionnaire_data. |
...
| VR | `lifestyle_context` | SSOT lifestyle fixture (alcohol_units_per_week=10, moderate+); no questionnaire_data. |
...
- Golden outputs (per run): `docs/audit-papers/launch-core-proving/artifacts/20260517T081551Z/` — written by `run_golden_panel`; omit bulk artefacts from git if desired.
