...
- Golden outputs (per run): `docs/audit-papers/launch-core-proving/artifacts/20260512T204115Z/` — written by `run_golden_panel`; omit bulk artefacts from git if desired.
