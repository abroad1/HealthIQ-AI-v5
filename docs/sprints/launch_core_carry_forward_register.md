...
| CF-BATCH2-003 | PASS3-BATCH2-INGEST-1 | Promotion readiness review for Batch 2 frames after indexing | Packages compiled but promotion blocked until frame-index registration and ROUTE_C adjudication complete. | No | Post CF-BATCH2-001 promotion review | Open | Depends on CF-BATCH2-001; androgen panel signals require medical review before promotion. |
