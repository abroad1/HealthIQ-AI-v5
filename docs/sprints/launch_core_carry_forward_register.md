...
| CF-MRIMPROVE-001 | CRP-PASS3-MIGRATION | Study-derived package cohort Pass 3 alignment | Three packages use `knowledge_bus/research/study_*.md` sources: `pkg_chronic_inflammation`, `pkg_insulin_resistance`, `pkg_hepatic_metabolic_stress`. All runtime-loaded; none Pass 3–sourced. | No | Medical research improvement programme | Open | Estate audit 2026-05-31. |
...
As of CRP-PASS3-MIGRATION provenance addendum (2026-05-31), there are no known launch-blocking carry-forwards. Open items include Pass 3 CRP compile (CF-CRPPASS3-001), chronic inflammation Pass 3 frame (CF-CHRONICINFL-001), study-derived and kb45/architecture package research-improvement cohorts (CF-MRIMPROVE-001–004), root-cause migration (CF-ARCHLEG1-001), and partial validator inventory (CF-ARCHLEG1-004).
