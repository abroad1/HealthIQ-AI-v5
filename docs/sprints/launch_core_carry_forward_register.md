...
As of CRP-PASS3-MIGRATION closure, there are no known launch-blocking carry-forwards. Open items include Pass 3 CRP package compile (CF-CRPPASS3-001), root-cause dual-authority migration (CF-ARCHLEG1-001), partial validator promotion inventory (CF-ARCHLEG1-004), compile automation, hypothesis surfacing, NarrativePayload persistence, lineage, and test-hardening improvements.
