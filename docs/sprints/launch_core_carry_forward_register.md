...
| CF-BATCH2-011 | BATCH2-CLOSURE-1 | Execute BATCH2-PROMOTE-1 for cleared Batch 2 package subset | 10 packages cleared for controlled promotion sprint; 8 androgen + 2 egfr excluded. | No | BATCH2-PROMOTE-1 | Open | Scope: creatine_kinase (2), eosinophil_pct (2), eosinophils_abs (2), free_t3 (2), free_t4 (2). Register: `batch2_final_promotion_decision_register_v1.yaml`. |
