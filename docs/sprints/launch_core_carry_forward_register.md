...
| CF-BATCH2-006 | BATCH2-PROMOTION-READINESS-1 | Promote Wave B cautious Batch 2 candidates | 10 packages (creatine_kinase, eosinophil_pct/abs, free_t3, free_t4) classified READY_WITH_DOCUMENTED_CAUTION. | No | Batch 2 Wave B promotion pilot | Open | No Wave A first candidates exist; Wave B is first eligible promotion cohort after clinical sign-off for thyroid subset. |
| CF-BATCH2-007 | BATCH2-PROMOTION-READINESS-1 | Adjudicate Wave D egfr multi-frame candidates | 2 egfr frames require adjudication vs creatinine legacy eGFR override before promotion. | No | egfr frame adjudication sprint | Open | Both pkg_kb47_egfr_* packages BLOCKED_PENDING_FRAME_ADJUDICATION. |
| CF-BATCH2-008 | BATCH2-PROMOTION-READINESS-1 | Thyroid-panel clinical sign-off before promotion | 4 free_t3/free_t4 frames in Wave B cautious cohort. | No | Thyroid promotion or medical review sprint | Open | Technically ready with caution; requires clinical adjudication sign-off before activation. |
...
| CF-BATCH2-010 | BATCH2-MEDREVIEW-1 | Androgen-panel clinical sign-off before activation | Medical review complete but no frame cleared for activation without clinical adjudication. | No | Clinical sign-off / promotion gate sprint | Open | Governance context binding complete (CF-BATCH2-009); all 8 frames remain compiled_not_promoted pending clinical signoff. |
