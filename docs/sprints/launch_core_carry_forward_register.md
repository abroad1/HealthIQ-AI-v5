...
| CF-PASS3FRAME-001 | PASS3-FRAME-COVERAGE-1 | Expand medical frame identity index to top high-risk multi-frame families | Only creatinine indexed; ALT, CRP, ferritin, apoB at high collapse risk per estate audit. | No | PASS3-FRAME-INDEX-2 | Open | See medical_frame_identity_expansion_candidates_v1.yaml. |
...
| CF-PASS3FRAME-003 | PASS3-FRAME-COVERAGE-1 | Promotion pause list for edge-case-loss risk | 47/55 packages blocked for promotion; bulk ROUTE_A wave unsafe without frame gates. | No | PASS3-FRAME-COVERAGE-1 | Open | Do not bulk-promote until CF-PASS3FRAME-001/002 progress. |
...
As of PASS3-FRAME-COVERAGE-1 closure (2026-06-02), there are no known launch-blocking carry-forwards. Estate-wide frame coverage audit classifies 55/55 packages; bulk ROUTE_A promotion paused (CF-PASS3FRAME-003). Identity index expansion (CF-PASS3FRAME-001), enrichment queue (CF-PASS3FRAME-002), creatinine enrichment (CF-CREATININE-001), and Layer B modifiers (CF-CONTEXT-MOD-2) remain open. No runtime behaviour changes.
