...
| CF-BATCH2-003 | PASS3-BATCH2-INGEST-1 | Promotion readiness review for Batch 2 frames after indexing | Packages compiled but promotion blocked until frame-index registration and ROUTE_C adjudication complete. | No | Post-indexing promotion review sprint | Open | All 16 Batch 2 families indexed; provenance canonical; promotion still blocked — clinical adjudication required on all frames. |
