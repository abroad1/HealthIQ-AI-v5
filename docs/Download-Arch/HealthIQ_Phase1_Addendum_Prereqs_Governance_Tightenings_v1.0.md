...
- No “order this test” language; output uses “consider discussing/including” framing.
...
- Enforce promotion state visibly in the registry (future enhancement): e.g., `status: experimental|promoted`.
