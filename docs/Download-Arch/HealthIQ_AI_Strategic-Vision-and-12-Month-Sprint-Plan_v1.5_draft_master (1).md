...
### Purpose of this wave
Wave 6 enables user-facing narrative only after the engine underneath is broad, truthful, explainable, phenotype-aware, and context-aware enough to deserve translation.

### Why this wave exists
Narrative must be the last layer, not the first.
Otherwise the platform risks sounding intelligent without actually being trustworthy.
