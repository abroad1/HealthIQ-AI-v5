# KNOWLEDGE BUS PASS3 PROMOTION PROTOCOL v1.0
...
Every promotion run should emit a compile manifest or equivalent metadata record.
...
# 10. Relationship to Knowledge Bus SOP
...
# 11. Relationship to Automation Bus SOP
...
# 12. Validation and Enforcement Boundaries

## 12.1 What is currently operational
...
## 12.2 What is not yet fully operational
...
# 13. Interim Operational Rule

Until the full compiler / promotion chain is implemented, the following interim rule applies:

- canonical research remains the authoritative medical source
- package files may be promoted only when their lineage to canonical research is explicit
- any compiled artefact introduced from canonical research must document source lineage manually if automated compile manifests are not yet available
