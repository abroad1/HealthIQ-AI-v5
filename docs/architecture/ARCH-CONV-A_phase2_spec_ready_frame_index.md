...
| 9 | 3 | signal_creatinine_high | inv_creatinine_high_renal | signal_creatinine_high::inv_creatinine_high_renal | knowledge_bus/research/investigation_specs/inv_creatinine_high_renal_v1.yaml | **PACK ASSEMBLED (Wave 3 STOP B)** |
| 10 | 3 | signal_urea_high | inv_urea_high_renal | signal_urea_high::inv_urea_high_renal | knowledge_bus/research/investigation_specs/inv_urea_high_renal.yaml | **PACK ASSEMBLED (Wave 3 STOP B)** |
| 11 | 3 | signal_urate_high | inv_uric_acid_high_metabolic | signal_urate_high::inv_uric_acid_high_metabolic | knowledge_bus/research/investigation_specs/inv_uric_acid_high_metabolic.yaml | **PACK ASSEMBLED (Wave 3 STOP B)** |
...
**Identity note (Wave 3):** row 9 uses embedded `inv_creatinine_high_renal` (not filename `…_renal_v1`). Row 11 uses `inv_uric_acid_high_metabolic` with primary biomarker `urate` / signal `signal_urate_high` — one frame; no parallel uric_acid signal alias.
