...
| Merge tip SHA (feature FF) | `7db1495` | FF merge of feature into `main` |
| Published `main` == `origin/main` | Verified aligned | Final published tip recorded in chat / `git rev-parse`; do not chase self-referential SHA edits |
