  ...
  theme: {
    ...
    extend: {
      ...
      boxShadow: {
        ...
        'medical-hover': '0 8px 32px rgba(37, 99, 235, 0.25)',
        'medical-card': '0 2px 12px rgba(37, 99, 235, 0.08)',
        'medical-intense': '0 6px 24px rgba(37, 99, 235, 0.20)',
        'float': '0 8px 25px rgba(0, 0, 0, 0.08)',
      },
      screens: {
        'xs': '475px',
        'sm': '640px',
