...
If the operator has separately instructed you to emit a failure report, do so there. Otherwise, preserve the batch and avoid disguised regeneration.
...
4. Do override descriptions match their encoded conditions exactly?
5. Are hypotheses materially distinct and sufficiently developed?
6. Are supporting markers functionally justified rather than decorative?
7. Are contradiction markers present where clinically needed?
8. Are condition labels honest and properly scoped?
9. Is naming consistent with actual object scope?
10. Would this batch now be suitable for Pass 3 clinical claim calibration rather than requiring another discovery pass?
