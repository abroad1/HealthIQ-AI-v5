...
def test_mr_batch_001b_write_test_output_report(candidate_pack) -> None:
    ...
    lines.extend(
        [
            ...
            "",
            "**Current disposition:** Round 1 benchmark / test fixture only — not medically approved; "
            "not for promotion; not for production runtime; useful only as evidence for future Round 2 prose pipeline design.",
            "",
        ]
    )
