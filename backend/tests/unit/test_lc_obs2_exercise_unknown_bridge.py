"""
LC-OBS-2 — questionnaire exercise absence must not coerce to zero minutes at mapper bridge.

Bounded orchestrator checks for baseline vs partial questionnaire parity + statin invariants.
"""
