...
def test_ft3_high_emits_when_ft3_high_tsh_suppressed_and_ft4_not_elevated():
    signal = _load_package_signal(
        "pkg_kb47_free_t3_high_t3_predominant_thyrotoxicosis",
        "signal_free_t3_high",
    )
    results = _evaluate_signal(signal, {"free_t3": 5.0, "tsh": 0.2, "free_t4": 1.2})
...
def test_ft4_low_emits_when_ft4_low_and_tsh_high():
    ...
    results = _evaluate_signal(signal, {"free_t4": 0.5, "tsh": 6.0})
